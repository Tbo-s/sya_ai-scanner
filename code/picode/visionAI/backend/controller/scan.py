...
from services.scan_orchestrator import ScanOrchestrator, ScanSession

router = APIRouter()

# Singleton – injected from websrv.py at startup
_orchestrator: Optional[ScanOrchestrator] = None


def set_orchestrator(o: ScanOrchestrator):
